...
exports.criarProfissional = async (req, res) => {
    try {
        const { nome, matricula_profissional, especialidade, foto_perfil, quant_atend_gratis, faixas_etarias, cidade, estado, genero, idade, valor, usuarioId} = req.body;
        const novoProfissional = await profissionalModel.criarProfissional(nome, matricula_profissional, especialidade, foto_perfil, quant_atend_gratis, faixas_etarias, cidade, estado, genero, idade, valor, usuarioId);
...
exports.atualizarProfissional = async (req, res) => {
    try{
        ...
        const profissionalAtualizado = await profissionalModel.atualizarProfissional(parseInt(id), nome, matricula_profissional, especialidade, foto_perfil, quant_atend_gratis, faixas_etarias, cidade, estado, genero, idade, valor, usuarioId);
